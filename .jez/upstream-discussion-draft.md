# Sidebar chat organisation: right-click menu, colour/icon tags, and folders

> **Where to post**: https://github.com/block/goose/discussions/new?category=ideas
>
> **Title**: Sidebar chat organisation: right-click menu, colour/icon tags, and folders
>
> Drop your screenshots into the `[Screenshot: …]` placeholders before posting. GitHub's editor accepts drag-and-drop into the body.
...
Four commits, each atomic enough to become its own PR if you want to take this piecemeal:
